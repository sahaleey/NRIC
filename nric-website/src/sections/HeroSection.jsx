  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-zinc-900">
      ...
      >
        ...
        >
          <span className="block text-white [text-shadow:0_4px_12px_rgb(0_0_0_/50%)]">
            Nahjurrashad
          </span>
          <span className="block text-3xl md:text-4xl lg:text-5xl mt-2 text-green-500 font-light">
            Islamic College
          </span>
        </motion.h1>
